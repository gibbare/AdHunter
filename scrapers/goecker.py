"""
Goecker scraper – goecker.com
Begagnat-avdelning / second-hand.
"""
import requests
...
def search(query: str, max_price: Optional[int] = None, min_price: Optional[int] = None) -> list[dict]:
    ...
    for card in soup.select(".product-card, .product, .item, article, li.product"):
